...
@Service
public class OceanbaseUpgradeDao extends UpgradeDao {
    public static final Logger logger = LoggerFactory.getLogger(OceanbaseUpgradeDao.class);

    private OceanbaseUpgradeDao(DataSource dataSource) {
        super(dataSource);
    }

    @Override
    protected String initSqlPath() {
        return "create/release-1.2.0_schema/mysql";
    }
